...
{
	/**
	 * Konstruktor - inicjalizuje obiekt misji zniszczenia
	...
	/**
	 * Obsługuje zdarzenie dotarcia floty do celu
	 * Przeprowadza bitwę pomiędzy atakującym a obrońcą, oblicza zniszczenia i możliwość zniszczenia księżyca
	 */
